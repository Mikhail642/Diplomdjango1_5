...
def display_perspektive_ispolzovania(request):
    project = Project.objects.filter(avtor=request.user)
    return render(request, 'display_perspektive.html',{'project':project})

def display_plan_realization(request):
    project = Project.objects.filter(avtor=request.user)
    return render(request, 'display_plan_realization.html',{'project':project})

def display_prognoz_razvitia(request):
    project = Project.objects.filter(avtor=request.user)
    return render(request, 'display_prognoz_razvitia.html',{'project':project})
...
def display_function(request):
    project = Project.objects.filter(avtor=request.user)
    return render(request, 'display_function.html', {'project': project})

def display_function_v_project(request):
    project = Project.objects.filter(avtor=request.user)
    return render(request, 'display_function_v_project.html', {'project': project})
