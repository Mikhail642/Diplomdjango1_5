...
class Project(models.Model):
    ...
    provereno = models.BooleanField('Отметка об отсутствии ошибок', default=False,)
    avtor = models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE, verbose_name='Автор')
...
class FunctionVProject(models.Model):
    ...
    id_function = models.ForeignKey(Project, verbose_name='Айди проекта', on_delete=models.CASCADE,
