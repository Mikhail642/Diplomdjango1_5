...
class ProjectAdmin(admin.ModelAdmin):
    list_display = ["data_realizachii_s", "data_realizachii_po", 'selka_na_saite', 'product_innovation_deatelnosti',
                    'rukovoditel_organization', 'nauche_rukovoditel', 'predloshenie_po_ispolzovanie',
                    'nauche_rukovoditel', 'name_organization']
...
class FunctionVProjectAdmin(admin.ModelAdmin):
    ...
    list_display_links = ["name_function"]
    list_display = ["id_function"]
...
admin.site.register(PerspektiveIspolzovaniaRezultatovProektaVmassovoiPraktike,
                    PerspektiveIspolzovaniaRezultatovProektaVmassovoiPraktikeAdmin)
